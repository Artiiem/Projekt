...
Najlepszym zbudowanym modelem okazał się las losowy. Posiada największą wartość R.squared oraz najmniejsze wartości RMSE oraz MAE. Mimo to R.squared równy 0.69 nie jest ciągle wartością zadowalającą. Prawie 70% wyjaśnienia zmienności pozostawia sporą szansę na popełnienie błędu przez model.
